...
Üretime alınmış olanlar.

⏱️ [TeamTime](https://github.com/kaysman/ikay-production-portfolio/tree/main/teamtime) - Basecamp için zaman takibi, doğru şekilde. Ek hesap gerektirmeyen canlı Basecamp entegrasyonu, 1–2 dokunuşla kayıt ve yalnızca gerekli minimum veriyi saklayan gizlilik öncelikli yapı

🔢 [Raqam971](https://github.com/kaysman/ikay-production-portfolio/tree/main/raqam971) - BAE genelinde özel plaka ve telefon numaralarının alınıp satıldığı pazar yeri

💳 [Digitax](https://github.com/kaysman/ikay-production-portfolio/tree/main/digitax) - Clean Architecture üzerine kurulu, Stripe entegrasyonlu ve çevrimdışı öncelikli veri senkronizasyonuna sahip ödeme uygulaması

🔐 [THXConnect Wallet](https://github.com/kaysman/ikay-production-portfolio/tree/main/thxconnect) - NFT yönetimi ve Japonya pazarına özel özellikler (My Number) sunan Web3 cüzdan ve DAO platformu

🏃 [HealthyHour](https://github.com/kaysman/healthy_hour) - İş-yaşam dengesi için sağlık uygulaması: aktivite takibi, hareket molası hatırlatıcıları ve sağlık izleme

Her projenin detayları — teknoloji yığını, rol, ekran görüntüleri — [portföyün tamamında](https://github.com/kaysman/ikay-production-portfolio).
